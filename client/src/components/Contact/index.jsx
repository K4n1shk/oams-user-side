...
const Contact = () => {
    return (
        <div>
            <Navbar />
            <body className=" text-neutral-50 px-8 py-12">
                <div
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            ...
                            <div className="text-gray-700 mt-8">
                                Hate forms ? Send us an <span className="hover:underline hover:decoration-red-800"><a href="mailto:https://119cs0031@iitk.ac.in" target="_blank" rel="noreferrer">Email</a></span> instead.
                            </div>
                        </div>
